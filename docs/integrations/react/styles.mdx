...
[style sheet](../../dev/css-in-js/style-sheets/components.mdx) that is conditionally rendered to CSS
...
[variants](../../dev/css-in-js/style-sheets/components.mdx#variants). All that's required is to pass
...
[component style sheet](../../dev/css-in-js/style-sheets/components.mdx) format and instead uses
